<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="nombre" name="nombre" placeholder="Nombre del Evento" 
        value="<?php echo $evento->nombre ?? '' ?>">
    </div>

    <div class="formulario__campo">
        <label for="descripcion" class="formulario__label">Descripción</label>
        <textarea rows="8" class="formulario__input" id="descripcion" name="descripcion" placeholder="Descripción del Evento" 
    ...
    <div class="formulario__campo">
        ...
        <select class="formulario__select" id="categoria" name="categoria_id">
            ...
            <option selected="true" disabled value="">- Seleccionar - </option>
